...
set -U fish_user_paths $HOME/.local/bin $HOME/go/bin $HOME/Applications $fish_user_paths
...
# The bindings for !! and !$ along with Vi mode configurations
function fish_user_key_bindings
    # Enable vi key bindings
    fish_vi_key_bindings

    # Bind jk to switch to normal mode from insert mode
    bind -M insert -m default jk backward-char
    
    # Restore standard historical expansion bindings in insert mode
...
set -gx PATH "/home/defc0n/.local/bin" $PATH
